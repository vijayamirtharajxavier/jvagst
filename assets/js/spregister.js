...
$("#spsearch_btn").on('click',function(){
  console.log('sales register');

var trans_type = $("#ldgacc").val();
var fdate = $("#fromDate").val();
var tdate = $("#toDate").val();

getSaleslist(trans_type,fdate,tdate);
...
*/
   ...
   $(document).on('click','#spsearch_btn', function() {
...
function getSaleslist(trans_type,fdate,tdate)
{
  //Sales list
  console.log('sal reg');
 urlstr = 'getallSalesPlist?trans_type='+trans_type+'&fdate='+fdate+'&tdate='+tdate;
