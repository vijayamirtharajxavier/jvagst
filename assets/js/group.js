...
$(document).ready(function(){
 ...
 urlstr = 'group/getallgrouplist';
 url = urlstr.replace("undefined","");
 //  date("d-m-Y", strtotime($originalDate));
//console.log('fmDate ' + fmDate + ' toDate ' + toDate);
//managegroupTable = $("#groupTable").dataTable().fnDestroy();
 managegroupTable =  $('#groupTable').DataTable( 
  {
    "destroy": true,
...
function updateProductbyid(id)
{
 ...
 var url="groups/getProductforUpdate";
        $.ajax({
            url: url+'?id='+id,
...
$('#deleteModal').modal('hide');
    ...
    var urlstr =  'groups/deleteProduct';
...
$('.productname').autocomplete({
    source: function (request, response) {
        $.getJSON("groups/getproductdatabykeyword?itemkeyword=" + request.term, function (data) {
...
$.getJSON("groups/getproductdatabysearch?itemkeyword=" + ui.item.value, function (data, status) {
console.log(data);
