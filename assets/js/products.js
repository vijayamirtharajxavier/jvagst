...
var caturl = 'products/getProductCat';

$("#productcat").load(caturl);

    console.log('Search Clicked');
 urlstr = 'products/geProductbyCid';
...
$('.productname').autocomplete({
	...
	select: function(e,ui) {
		...
		$.getJSON("products/productbyname?itemkeyword=" + ui.item.value, function (data, status) {
		//console.log(data);
