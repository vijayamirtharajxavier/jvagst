...
$("#genledgerForm").unbind('submit').bind('submit', function() {
	var form = $(this);
...
var fdate= $("#fromDate").val();
var tdate=$("#toDate").val();
var acctid=$("#ldgacc").val();
var ldg_name = $("#ldgacc option:selected").text();
var w = window.open("print_ledgerlist?ldgname="+ ldg_name+ "&ldgacc="+acctid + "&fdate=" + fdate + "&tdate=" + tdate);
if ( w ) {
	w.onload = function() {
			// Do stuff
