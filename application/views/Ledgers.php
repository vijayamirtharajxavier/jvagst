...
$inputname ='<input  style="text-align:right;" id="accname['. $i .']" name="accname'. $i .'" value="' . $value["account_name"] . '" readonly>';

$inputfield ='<input place_holder="0.00" style="text-align:right;" id="opbal['.$i .']" name="opbal'. $i.'" value="' . $value["open_bal"] . '" >';

$data['data'][]= array('id'=>$value['id'], 'name'=>$inputname,'openbal'=>$inputfield);
$i++;
}
