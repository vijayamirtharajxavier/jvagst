 ...
 <h1 class="h3 mb-2 text-gray-800"><?php echo $page; ?></h1>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              ...
              <button style="float: right;" class="pull-right btn btn-primary" href="#"  data-toggle="modal" data-backdrop="static" data-keyboard="true" data-target="#modalAddSales" onclick="addSale('SRTN')"><i class="fa fa-plus"></i> New Credit Note</button> </h6>
            </div>
            
<div id="delete-rsales-message"></div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="rsaleslistTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
										<th>ACTION</th>
                      <th>CR.NOTE#</th>
...
<input type="text" id="flag" name="flag" value="SRTN" hidden>
...
<!-- Form -->
<form class="text-center" style="color: #757575;" action="editSales" method="POST" id="editRSalesForm">
