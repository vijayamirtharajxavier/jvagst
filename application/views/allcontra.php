...
<div id="delete-contra-message"></div>
            
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary"><?php echo $page; ?>
              <button style="float: right;" class="pull-right btn btn-primary" href="#"  data-toggle="modal" data-backdrop="static" data-keyboard="true" data-target="#modalAddcontra"><i class="fa fa-plus"></i> New contra</button> </h6>
            </div>
            
<div id="delete-contra-message"></div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-striped table-bordered dt-responsive nowrap" id="contralistTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>ACTION</th>
                      <th>CONTRA#</th>
...
<!--Add Modal -->
<div id="modalAddcontra" style="width: 1200px;" class="modal fade"  role="dialog">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add Contra</h5>

                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                </div>
<div id="add-contra-message" class="pull-right"></div>
<div id="add-error-contra-message" class="pull-right"></div>


<!-- Form -->
<form class="text-center" style="color: #757575;" action="createcontra" method="POST" id="addcontraForm">

<div class="modal-body">


<table id="contra" class="table table-bordered">
<tr><td>Contra#<input type="text" class="form-control" autocomplete="off"  id="contrano" name="contrano" readonly></td><td>Contra Date<input type="date" class="form-control" autocomplete="off"  id="contradate" name="contradate" required></td><td>Debit Account<input type="text" class="form-control dbaccount" autocomplete="off" id="dbaccount" name="dbaccount" required></td><td>Credit Account<input type="text" class="form-control craccount" autocomplete="off"  id="craccount" name="craccount" required></td></tr><tr><td>Amount <input type="text" class="form-control" style="text-align: right;" autocomplete="off"  id="trans_amount" name="trans_amount"></td><td>Trans Ref#<input type="text" class="form-control" autocomplete="off"  id="transref" name="transref"></td><td colspan="2">Narration<input type="text" class="form-control" autocomplete="off"  id="narration" name="narration"></td></tr>
</table>
...
<!--Edit Modal -->
<div id="modalEditcontra" style="width: 1200px;" class="modal fade"  role="dialog">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Edit Contra</h5>

                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                </div>
<div id="edit-contra-message" class="pull-right"></div>
<div id="edit-error-contra-message" class="pull-right"></div>


<!-- Form -->
<form  action="editcontra" method="POST" id="editcontraForm">

<div class="modal-body">
<div class="show-edit-contra-result"></div>
<!-- Material form register -->
<input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
                </div>
...
<script src="<?php echo base_url();?>assets/js/contra.js"></script>
