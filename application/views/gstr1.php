...
<div class="inline-group" style="float: left;">GSTR1  <input id="mn" type="radio" name="mn_qr">&nbsp;Monthly &nbsp; <input type="radio" id="qr" name="mn_qr">  Quarterly&nbsp;  Select a month for GSTR1  <input disabled="true" style="width:10em;height: 1.5em;" type="text" name="fromDate" id="fromDate" >&nbsp;Select Quater for GSTR1  <select disabled="true" id="gstr1_quater" name="gstr1_quater"><option value="04-06">APR-JUN</option><option value="07-09">JUL-SEP</option><option value="10-12">OCT-DEC</option><option value="01-03">JAN-MAR</option> </select>&nbsp; <button class="pull-right btn btn-primary" id="search_btn"><i class="fa fa-search"></i></button></div>
...
<div class="container-fluid">
 ...
 <!--<h1 class="h3 mb-2 text-gray-800"><?php echo $page; ?></h1>-->
          ...
          <div class="card shadow mb-4">
            ...
            <table id="gstr1b2blistTable" class="table table-striped table-bordered dt-responsive nowrap">
              <thead>
                <tr>
                <th>GSTIN</th>
                <th>NAME</th>
...
<script src="<?php echo base_url();?>assets/js/gstr1.js"></script>
