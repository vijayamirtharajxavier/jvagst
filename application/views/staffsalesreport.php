          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary"><?php echo $page; ?>
							<form class="text-center" style="color: #757575;" action="getStaffSales" method="POST" id="staffSalesForm">
							<div style="float:right;">Select a Staff <select id="stfacc" name="stfacc" style="width: 15em;height: 2em"></select>&nbsp;&nbsp; From &nbsp;<input type="date" id="fdate" name="fdate" required >&nbsp;To &nbsp;<input type="date" id="tdate" name="tdate" required>&nbsp;<button type="submit" class="btn btn-primary">Search</button></div> 
...
<button id="downloadstf-xls" class="btn"><i class="fas fa-file-excel"></i></i></button>
<button style="float:left" id="downloadstf-pdf" class="btn"><i style="color:red" class="fas fa-file-pdf"></i></button>

<div id="staffsales-table"></div>
