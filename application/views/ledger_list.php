...
<div class="input-group">
  ...
  <input id="ledgergstin"
    ...
    aria-describedby="basic-addon2"
		...
		name="ledgergstin" class="form-control checkgst" autocomplete="off"/>
  <span class="input-group-text" id="basic-addon2"><i id="tick" class="fa fa-check-circle" aria-hidden="true"></i></span>
</div>
