 ...
 <h1 class="h3 mb-2 text-gray-800"><?php echo $page; ?></h1>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              ...
              <button style="float: right;" class="pull-right btn btn-primary" href="#"  data-toggle="modal" data-backdrop="static" data-keyboard="true" data-target="#modalAddRPurchase" onclick="addSale('PRTN')"><i class="fa fa-plus"></i> New Debit Note</button> </h6>
            </div>
            
<div id="delete-rsales-message"></div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="rpurchaselistTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
										<th>ACTION</th>
                      <th>CR.NOTE#</th>
...
<!--Add Modal -->
<div id="modalAddRPurchase" style="width: 1200px; margin-left: 50px;" class="modal fade"  role="dialog">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add Sales Returns</h5>
...
<!-- Form -->
<form class="text-center" style="color: #757575;" action="editSales" method="POST" id="editRPurchaseForm">

<div class="modal-body">
<div id="loader" class="eloader"></div>
<div class="show-edit-rpurchase-result"></div>
<input type="text" id="flag" name="flag" value="PRTN" hidden>
