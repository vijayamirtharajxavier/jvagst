...
<?php  include 'layouts/navbar.php';  ?>
 ...
 <form class="text-center" style="color: #757575;" action="updateOpbal" method="POST" id="updateOpBalForm">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary"><?php echo $page; ?>
							...
							<button type="submit" style="float: right;" onclick="Convert();" class="pull-right btn btn-primary" href="#" ><i class="fa fa-save"></i> </button>  </h6>
            </div>
            
					<div id="delete-sales-message">
   ...
   <div class="table-responsive">  
    <!--<div id="optbl"></div> 
		<table id="optbl"></table> -->
		<div class="input-group mb-4">
  <input type="text" class="form-control account_name" placeholder="Search an account" aria-label="account_name" id="account_name" name="account_name" required>
  <input type="text" id="openbal_amt" style="width:10px;text-align:right;" name="openbal_amt" autocomplete="off" class="form-control" placeholder="0.00" style="text-align:right;" required>
<input type="text" id="acct_id" name="acct_id" hidden>
&nbsp;&nbsp;<button type="submit" class="btn btn-primary"><i class="fa fa-plus">&nbsp; Add</i></button>
                ...
                <table class="table table-bordered nowrap" id="ledgeropTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th width="600px;">Account Name</th>
                      <th>OpBal</th>
											<th>Action</th>
...
<script src="<?php echo base_url();?>assets/js/ledgerop.js"></script>
