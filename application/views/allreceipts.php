...
<div id="delete-receipt-message"></div>
            
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary"><?php echo $page; ?>
              <button style="float: right;" class="pull-right btn btn-primary" href="#"  data-toggle="modal" data-backdrop="static" data-keyboard="true" data-target="#modalAddReceipt" onclick="updateTransid(' . $d['id'] . ')"><i class="fa fa-plus"></i> New Receipt</button> </h6>
            </div>
            
<div id="delete-receipt-message"></div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-striped table-bordered dt-responsive nowrap" id="receiptlistTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>ACTION</th>
                      <th>RECEIPT#</th>
...
<!--Add Modal -->
<div id="modalAddReceipt" style="width: 1200px;" class="modal fade"  role="dialog">
...
<div id="add-receipt-message" class="pull-right"></div>
<div id="add-error-receipt-message" class="pull-right"></div>


<!-- Form -->
<form class="text-center" style="color: #757575;" action="createReceipt" method="POST" id="addReceiptForm">

<div class="modal-body">
<div id="loader" class="aloader"></div>

<table id="Receipt" class="table table-bordered">
<tr><td>Receipt#<input type="text" class="form-control" autocomplete="off"  id="receiptno" name="receiptno" readonly></td><td>Receipt Date<input type="date" class="form-control" autocomplete="off"  id="receiptdate" name="receiptdate" required></td><td>Debit Account<input type="text" class="form-control dbaccount" autocomplete="off" id="dbaccount" name="dbaccount" required></td><td>Credit Account<input type="text" class="form-control craccount" autocomplete="off"  id="craccount" name="craccount" required></td></tr><tr><td>Amount <input type="text" style="text-align: right;" autocomplete="off" class="form-control" id="trans_amount" name="trans_amount"></td><td>Trans Ref#<input type="text" class="form-control" autocomplete="off"  id="transref" name="transref"></td><td colspan="2">Narration<input type="text" class="form-control" autocomplete="off"  id="narration" name="narration"></td></tr>
</table>
...
<!--Edit Modal -->
<div id="modalEditReceipt" style="width: 1200px;" class="modal fade"  role="dialog">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
...
<div id="edit-receipt-message" class="pull-right"></div>
<div id="edit-error-receipt-message" class="pull-right"></div>


<!-- Form -->
<form class="text-center" style="color: #757575;" action="editReceipt" method="POST" id="editReceiptForm">

<div class="modal-body">
  <div id="loader" class="eloader"></div>
<div class="show-edit-receipt-result"></div>
<!-- Material form register -->
<input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
                </div>
