...
<form class="text-center" style="color: #757575;" action="getCatSales" method="POST" id="categorySalesForm">
...
<button id="downloadcat-xls" class="btn"><i class="fas fa-file-excel"></i></i></button>
<button style="float:left" id="downloadcat-pdf" class="btn"><i style="color:red" class="fas fa-file-pdf"></i></button>
<input type="text" id="compname" name="compname" hidden>
<div id="categorysales-table"></div>
