...
<form class="text-center" style="color: #757575;" action="getCatStockItems" method="POST" id="stockdetailsForm">
...
<button id="downloadcatstk-xls" class="btn"><i class="fas fa-file-excel"></i></i></button>
<button style="float:left" id="downloadcatstk-pdf" class="btn"><i style="color:red" class="fas fa-file-pdf"></i></button>
