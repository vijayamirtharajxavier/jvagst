...
<?php  include 'layouts/navbar.php';  ?>
 ...
 <h1 class="h3 mb-2 text-gray-800"><?php echo $page; ?></h1>
          ...
          <div class="card shadow mb-4">
            <div id="delete-journal-message" class="pull-right"></div>
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary"><?php echo $page; ?>
              <button style="float: right;" class="pull-right btn btn-primary" href="#"  data-toggle="modal" data-backdrop="static" data-keyboard="true" data-target="#modalAddjournal"><i class="fa fa-plus"></i> New Journal</button> </h6>
            </div>
            
<div id="delete-journal-message"></div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-striped table-bordered dt-responsive nowrap" id="journallistTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>ACTION</th>
                      <th>JOURNAL#</th>
...
<!--Add Modal -->
<div id="modalAddjournal" style="width: 1200px;" class="modal fade"  role="dialog">
...
<!--Edit Modal -->
<div id="modalEditjournal" style="width: 1200px;" class="modal fade"  role="dialog">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
...
<div id="edit-journal-message" class="pull-right"></div>
<div id="edit-error-journal-message" class="pull-right"></div>


<!-- Form -->
<form class="text-center" style="color: #757575;" action="editjournal" method="POST" id="editjournalForm">

<div class="modal-body">
  <div id="loader" class="eloader"></div>
<div class="show-edit-journal-result"></div>
<!-- Material form register -->
<input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
                </div>
