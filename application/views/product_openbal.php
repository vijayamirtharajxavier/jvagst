...
<?php  include 'layouts/navbar.php';  ?>
 ...
 <form class="text-center" style="color: #757575;" action="updatestockOpbal" method="POST" id="updateStockOpBalForm">
  ...
  <input type="text" class="form-control prodname" placeholder="Search a product" aria-label="prodname" id="prodname" name="prodname" required>
  <input type="text" id="open_stock" style="width:10px;text-align:right;" name="open_stock" autocomplete="off" class="form-control" placeholder="0.00" style="text-align:right;" required>
...
&nbsp;&nbsp;<button type="submit" class="btn btn-primary"><i class="fa fa-plus">&nbsp; Add</i></button>
                ...
                <table class="table table-bordered nowrap" id="productopTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th width="600px;">Product Name</th>
                      <th>Op Stock</th>
											<th>Action</th>
