...
<div id="delete-cashbank-message"></div>
            ...
            <div class="card-header py-3">
              ...
              <div class="inline-group" style="float: left;">Account <select id="ldgacc" name="ldgacc" style="width: 15em;height: 2em"></select> From <input  style="width:10em;height: 1.5em;" type="date" name="fromDate" id="fromDate" >&nbsp; To <input type="date" name="toDate" id="toDate" style="width:10em;height: 1.5em">
              &nbsp;&nbsp;<button style="float: right;" class="btn btn-info" href="#" ><i class="fa fa-print" id="printCB"></i></button><button class="pull-right btn btn-primary" id="search_btn"><i class="fa fa-search"></i></button></div></h6>
...
<div id="delete-cashbank-message"></div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-striped table-bordered dt-responsive nowrap" id="cashbanklistTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>OPBAL</th>
                      <th>TRANS#</th>
...
<script src="<?php echo base_url();?>assets/js/cashbank.js"></script>
