...
<!--          <p class="mb-4">DataTables is a third party plugin that is used to generate the demo table below. For more information about DataTables, please visit the <a target="_blank" href="<?php base_url();?>assets/https://datatables.net">official DataTables documentation</a>.</p> -->
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              ...
              <button style="float: right;" class="pull-right btn btn-primary"  data-backdrop="static" data-keyboard="true"  data-toggle="modal" data-target="#modalAddGroup"><i class="fa fa-plus"></i> New Group</button> </h6>
            </div>
            
<div id="delete-product-message"></div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-striped table-bordered dt-responsive nowrap" id="ledgeropTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
...
<!--Add Modal -->
<div id="modalAdd_Group" style="width: 1200px;" class="modal fade"  role="dialog">
...
<div id="add-group-message" class="pull-right"></div>
<div id="add-error-group-message" class="pull-right"></div>


<!-- Form -->
<form class="text-center" style="color: #757575;" action="createGroup" method="POST" id="addGroupForm">

<div class="modal-body">
<div id="loader" class="aloader"></div>

<table id="Product" class="table table-bordered">
<tr><td>Group Name<input type="text" class="form-control groupname" autocomplete="off" required  id="groupname" name="groupname" ></td></tr>
</table>
...
<!--Edit Modal -->
    <div id="modalEditGroup" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
...
<div id="edit-group-message" class="pull-right"></div>
<div id="edit-error-group-message" class="pull-right"></div>


        <!-- Form -->
<form class="text-center" style="color: #757575;" action="products/editGroup" method="POST" id="editGroupForm">

 <div class="modal-body">

                    <!--<p>Add the <code>.modal-xl</code> class on <code>.modal-dialog</code> to create this extra large modal.</p> -->
<div class="show-result-group"></div>
<!-- Material form register -->
<input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>" value="<?php echo $this->security->get_csrf_hash();?>">
                </div>
    ...
    <div class="card-body px-lg-5 pt-0">
            ...
            <div class="form-row">
                <div class="col">
                    <!-- First name -->
                    <div class="md-form">
                        <label for="product_name">GROUP NAME</label>
