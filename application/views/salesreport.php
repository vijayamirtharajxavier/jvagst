 ...
 <h1 class="h3 mb-2 text-gray-800"><?php echo $page; ?></h1>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              ...
              <button style="float: right;" class="pull-right btn btn-primary" href="#"  data-toggle="modal" data-backdrop="static" data-keyboard="true" data-target="#modalAddSales" onclick="addSale('SALE')"><i class="fa fa-plus"></i> New Sales</button> </h6>
            </div>
...
<tr>
<td>Inv.#<input type="text" class="form-control" autocomplete="off"  id="invoiceno" name="invoiceno" readonly></td>
<td>Inv.Date<input type="date" class="form-control" autocomplete="off"  id="invdate" name="invdate" required></td>
<td>Order #<input type="text" class="form-control" autocomplete="off" id="orderno" name="orderno"></td>
<td>Sales by<select class="form-control" autocomplete="off" id="salebyperson" name="salebyperson" required>'. $soption .'</select></td>
</tr>
<tr>
<td>DC #<input type="text" class="form-control" autocomplete="off"  id="dcno" name="dcno"></td>
<td>DC Date<input type="date" class="form-control" autocomplete="off"  id="dcdate" name="dcdate"></td>
<td>Order Date<input type="date" class="form-control" autocomplete="off"  id="orderdate" name="orderdate"></td>
<td>Inv.Type<select  class="form-control" autocomplete="off" id="invtype" name="invtype" >'. $invoption .'</select> </td>
</tr>
<tr>
<td>Customer<div class="ui-widget"><input type="text" class="form-control customer_name" autocomplete="off"  id="customer_name" name="customer_name" required  style="overflow-auto: scroll;"></div></td>
<td>GSTIN#<input type="text"  class="form-control" autocomplete="off" id="gstin" name="gstin"  readonly></td>
<td>OUTSTANDING<input type="text" style="text-align:right;font-weight:bold;" class="form-control" autocomplete="off" id="outstanding" name="outstanding"  readonly></td>
<td>CREDIT PERIOD<input class="form-control" type="text" id="creditperiod" name="creditperiod" ></td>

</tr>
</table>
<input type="text" id="flag" name="flag" value="SALE" hidden>
<input type="text" id="cr_acct" name="cr_acct" value="<?php echo $cr_account; ?>" hidden>


<div class="table-responsive"style="overflow:auto; height:200px;"><table id="InvoiceItems" border="1" ><tr><thead><th>Item Name</th><th>Item Description</th><th>HSNSAC</th><th>GST%</th><th>MRP</th><th>UOM</th><th>STOCK</th><th>QTY</th><th>RATE</th><th>DIS%</th><th>TAXABLE AMOUNT</th><th>NETT AMOUNT</th><th>?</th></thead></tr><tbody></tbody></table></div>
