 ...
 <h1 class="h3 mb-2 text-gray-800"><?php echo $page; ?></h1>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              ...
              <button style="float: right;" class="pull-right btn btn-primary" href="#"  data-toggle="modal" data-backdrop="static" data-keyboard="true" data-target="#modalAddPurchase"><i class="fa fa-plus"></i> New Purchase</button> </h6>
            </div>
            
<div id="delete-sales-message"></div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-striped table-bordered dt-responsive nowrap" id="purchaselistTable" width="100%" cellspacing="0">
                  <thead>
                    <tr>
                      <th>ACTION</th>
                      <th>INVOICE#</th>
...
<!--Edit Purchase Person Modal -->
<div id="modalPurchaseperson" class="modal fade" role="dialog">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Add / Edit Purchase Person</h5>
...
<!-- Form -->
<form class="text-center" style="color: #757575;" action="editPurchaseperson" method="POST" id="editPurchasepersonForm">
...
<tr><td>Inv.#<input type="text" class="form-control" autocomplete="off"  id="invoiceno" name="invoiceno"></td><td>Inv.Date<input type="date" class="form-control" autocomplete="off"  id="invdate" name="invdate" required></td><td>Order #<input type="text" class="form-control" autocomplete="off" id="orderno" name="orderno"></td><td>Order Date<input type="date" class="form-control" autocomplete="off"  id="orderdate" name="orderdate"></td><td>Inv.Type<select  class="form-control" autocomplete="off" id="invtype" name="invtype" >'. $invoption .'</select> </td></tr>
<tr><td>DC #<input type="text" class="form-control" autocomplete="off"  id="dcno" name="dcno"></td><td>DC Date<input type="date" class="form-control" autocomplete="off"  id="dcdate" name="dcdate"></td><td colspan="2">Customer<div class="ui-widget"><input type="text" class="form-control customer_name" autocomplete="off"  id="customer_name" name="customer_name" required  style="overflow-auto: scroll;"></div></td><td>GSTIN#<input type="text"  class="form-control" autocomplete="off" id="gstin" name="gstin"  readonly></td></tr>
</table>

<input type="text" id="flag" name="flag" value="PURC" hidden>
<input type="text" id="cr_acct" name="cr_acct" value="<?php echo $cr_account; ?>" hidden>

<div class="table-responsive"style="overflow:auto; height:200px;"><table id="InvoiceItems" border="1" ><tr><thead><th>Item Name</th><th>Item Description</th><th>HSNSAC</th><th>GST%</th><th>MRP</th><th>UOM</th><th>QTY</th><th>RATE</th><th>DIS%</th><th>TAXABLE AMOUNT</th><th>NETT AMOUNT</th><th>?</th></thead></tr><tbody></tbody></table></div>
...
<div id="modalEditRPurchase" style="width: 1000px; margin-left: 20px;" class="modal fade"  role="dialog">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                <div class="modal-header">
...
<!-- Form -->
<form class="text-center" style="color: #757575;" action="editRPurchase" method="POST" id="editRPurchaseForm">
