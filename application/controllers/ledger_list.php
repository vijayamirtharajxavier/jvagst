            ...
            <div class="form-row">
                ...
                <div class="col">
                    ...
                    <div class="md-form">
                        ...
                        <input type="text" oninput="this.value = this.value.toUpperCase()"  id="ledgergstin" name="ledgergstin" class="form-control checkgst" autocomplete="off">
                        <span><div class="spinner-border text-info" id="gst_spinner" role="status">
</div> 
</span>
                    </div>
                </div>
	...
	<div id="sts"></div>
            ...
            <div class="form-row">
                ...
                <div class="col">
                    <!-- First name -->
                    <div class="md-form">
                        <label for="ledgerpincode">PINCODE</label>
                        <input type="text" id="ledgerpincode" oninput="this.value = this.value.toUpperCase()"   style="text-align: right;" autocomplete="off" name="ledgerpincode" class="form-control">
