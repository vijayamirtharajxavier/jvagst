 ...
 <h1 class="h3 mb-2 text-gray-800"><?php echo $page; ?></h1>
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-header py-3">
              ...
              <button style="float: right;" class="pull-right btn btn-primary" href="#"  data-toggle="modal" data-backdrop="static" data-keyboard="true" data-target="#modalAddPurchase" onclick="addSale('SALE')"><i class="fa fa-plus"></i> New Purchase</button> </h6>
            </div>
...
<!-- Form -->
<form class="text-center" style="color: #757575;" action="createRPurchase" method="POST" id="createRPurchaseForm">
