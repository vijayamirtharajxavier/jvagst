...
function fetchFinyearSettings()
{
	$compId= $this->session->userdata('id');
	$finyear = $this->session->userdata('finyear');
	$data = array("compId"=>$compId);
//var_dump($data);
	$url = $this->config->item("api_url") . "/api/productlist/finyearsettings";
...
$data=array();
	...
	//var_dump($data_array);
	$url = $this->config->item("login_url") . "/api/users/usercompdetails";
...
{
$compid = $this->input->get('id');
$finyear = $this->input->get('finyear');
$curr_url = $this->input->get('curr_url');


$furl = $this->config->item("login_url") . "/api/finyear/" . $finyear . "/" . $compid ;
$ch = curl_init($furl);
...
$url = $this->config->item("api_url") . "/api/productlist/getCompany";
